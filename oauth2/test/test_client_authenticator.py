...
class ClientAuthenticatorTestCase(unittest.TestCase):
    ...
    def test_by_identifier(self):
        ...
        request_mock.get_param.side_effect = [self.client.identifier, redirect_uri]

        client = self.authenticator.by_identifier(request=request_mock)

        self.client_store_mock.fetch_by_client_id.assert_called_with(self.client.identifier)
    ...
    def test_by_identifier_unknown_client(self):
        ...
        self.client_store_mock.fetch_by_client_id.side_effect = ClientNotFoundError
    ...
    def test_by_identifier_secret(self):
        ...
        self.client_store_mock.fetch_by_client_id.assert_called_with(client_id)
...
class HttpBasicAuthTestCase(unittest.TestCase):
    def test_valid(self):
        ...
        request_mock = Mock(spec=Request)
        request_mock.header.return_value = "Basic {0}".format(encoded.decode("latin1"))
