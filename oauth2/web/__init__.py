...
class AuthenticatingSiteAdapter(object):
    ...
    def authenticate(self, request, environ, scopes, client):
        ...
        :param scopes: A list of strings with each string being one requested scope.
        :type scopes: list
...
class UserFacingSiteAdapter(object):
    ...
    def render_auth_page(self, request, response, environ, scopes, client):
        ...
        :return: The response passed in as a parameter. It can contain HTML or issue a redirect.
...
class AuthorizationCodeGrantSiteAdapter(UserFacingSiteAdapter, AuthenticatingSiteAdapter):
    """
...
class ImplicitGrantSiteAdapter(UserFacingSiteAdapter, AuthenticatingSiteAdapter):
    """
    Definition of a site adapter as required by
