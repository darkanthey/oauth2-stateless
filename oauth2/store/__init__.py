"""
Store adapters to persist and retrieve data during the OAuth 2.0 process or for later use.
This module provides base classes that can be extended to implement your own solution specific to your needs.
...
class AccessTokenStore(object):
    ...
    def fetch_existing_token_of_user(self, client_id, grant_type, user_id):
        """
        Fetches an access token identified by its client id, type of grant and user id.
        ...
        :raises: :class:`oauth2.error.AccessTokenNotFound` if no data could be retrieved.
        """
        raise NotImplementedError
    ...
    def fetch_by_refresh_token(self, refresh_token):
        ...
        :return: An instance of :class:`oauth2.datatype.AccessToken`.
        :raises: :class:`oauth2.error.AccessTokenNotFound` if no data could be retrieved for given refresh_token.
        """
        raise NotImplementedError
...
class AuthCodeStore(object):
    ...
    def fetch_by_code(self, code):
        ...
        :raises: :class:`oauth2.error.AuthCodeNotFound` if no data could be retrieved for given code.
        """
        raise NotImplementedError
...
class ClientStore(object):
    ...
    def fetch_by_client_id(self, client_id):
        ...
        :raises: :class:`oauth2.error.ClientNotFoundError` if no data could be retrieved for given client_id.
        """
        raise NotImplementedError
